export type VoiceoverTimingBeat = {
  id: string;
  sceneId: string;
  caption: string;
  audioSrc: string;
  ...
  beats: [
    {
        ...
        "audioSrc": "audio/ai_video_flow/beat_01_hook.mp3",
        "startFrame": 0,
        "durationInFrames": 250,
        "durationSeconds": 7.706122
    },
    {
        "id": "beat_02_core_shift",
        "sceneId": "scene_02_core_shift",
        "caption": "因为 AI 视频不是先堆模型和提示词，而是先想清楚主题、观点，再根据它写剧本。",
        "audioSrc": "audio/ai_video_flow/beat_02_core_shift.mp3",
        "startFrame": 250,
    ...
    },
    {
        ...
        "audioSrc": "audio/ai_video_flow/beat_06_editing.mp3",
        "startFrame": 1359,
        "durationInFrames": 351,
        "durationSeconds": 11.075918
    },
    {
        "id": "beat_07_takeaway",
        "sceneId": "scene_07_takeaway",
        "caption": "先想清楚影片要表达什么，再让 AI 帮你拍。工具负责生成镜头，导演负责让观众看懂。",
        "audioSrc": "audio/ai_video_flow/beat_07_takeaway.mp3",
        "startFrame": 1710,
        "durationInFrames": 258,
        "durationSeconds": 7.967347
    }
] satisfies VoiceoverTimingBeat[],
};
